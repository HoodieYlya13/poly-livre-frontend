...
export default function Information() {
  ...
  return (
    <div className="w-full md:w-1/2 flex items-center justify-center p-2 xs:p-5 md:p-12">
        ...
        <div className="w-full flex flex-col gap-5 text-xs @sm:text-sm @md:text-base">
          ...
          <div className="flex flex-row">
            <div className="w-1/3 flex flex-col">
              <h2 className="h-1/2 flex items-center justify-center text-xl @lg:text-2xl font-black">
                + 20 K
              </h2>
              <h4 className="h-1/2 flex items-center justify-center text-center">
